...
class EventSystem 
{
    // Alias for a subscriber function that takes a const reference to the event type.
    // Using std::function allows storing lambdas, function pointers, or bind expressions.
